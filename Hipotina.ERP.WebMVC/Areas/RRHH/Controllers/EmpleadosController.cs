...
namespace Hipotina.ERP.WebMVC.Areas.RRHH.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        // GET: RRHH/Empleados/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: RRHH/Empleados/Create
